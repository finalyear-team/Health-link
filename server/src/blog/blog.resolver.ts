...
export class BlogResolver {
  ...
  @Query('GetMyBlogs')
  async GetMyBlogs(@Args('DoctorID') DoctorID: string) {
    return await this.blogService.getMyBlogs(DoctorID);
  }
  ...
  async IncrementView(@Args('BlogID') BlogID: string) {
    return await this.blogService.incrementView(BlogID);
  }
